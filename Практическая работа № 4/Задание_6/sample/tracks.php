...
<head>
    <meta charset="UTF-8">
    <title>Задание № 6 — Полный список треков</title>
    <style>
        ...
        ol { padding-left: 20px; line-height: 1.6; font-size: 16px; }
...
<div class="container">
    ...
    <ol>
        <?php foreach ($track as $item): ?>
            <li>(id=<?= htmlspecialchars($item['id_track']) ?> ) <?= htmlspecialchars($item['name']) ?></li>
        <?php endforeach; ?>
    </ol>
</div>
