...
<head>
    <meta charset="UTF-8">
    <title>Задание № 7 — Треки альбома</title>
    <style>
        body { font-family: Arial, sans-serif; margin: 40px; background-color: #f4f4f9; color: #333; }
        .container { max-width: 650px; background: white; padding: 25px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin: 0 auto; }
        h3 { color: #2c3e50; font-weight: bold; margin-top: 0; margin-bottom: 20px; }
        ul { padding-left: 20px; line-height: 1.6; font-size: 16px; }
...
<div class="container">
    <h3>Треки альбома Back in Black (AC/DC):</h3>

    <?php
    // Полный массив данных из вашего файла tracks.php
    $track = array(
